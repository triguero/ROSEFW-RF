...
import org.apache.mahout.classifier.smo.mapreduce.*;
...
public class PartialBuilder extends Builder {
  ...
  public PartialBuilder(SMOgenerator smo_algorithm, Path dataPath, Path datasetPath, String testPath, String reduceType, String cabecera) {
    this(smo_algorithm, dataPath, datasetPath, testPath, reduceType, new Configuration(), cabecera);
  }
  
  public PartialBuilder(SMOgenerator smo_algorithm,
                        Path dataPath,
                        Path datasetPath,
                        String testPath, String reduceType,
                        Configuration conf, String cabecera) {
    super(smo_algorithm, dataPath, datasetPath, testPath, reduceType, conf, cabecera);
  }
